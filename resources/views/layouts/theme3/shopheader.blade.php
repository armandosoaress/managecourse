            ...
            <div class="logo-col">
                <h1>
                    <a href="{{route('store.slug',$store->slug)}}">
                        @if(!empty($store->logo))
                            <img alt="lmsgo-logo" src="{{\App\Models\Utility::get_file('uploads/store_logo/'.$store->logo.'?'. time())}}" id="img-fluid">
                        @else
                            <img alt="lmsgo-logo" src="{{asset(Storage::url('uploads/store_logo/logo.png'.'?'. time()))}}" id="img-fluid">
                        @endif
                    </a>
                </h1>
            </div>
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="user-image">
                                                @if(!empty(Auth::guard('students')->user()->avatar))
                                                    <img src="{{\App\Models\Utility::get_file('uploads/profile/'.Auth::guard('students')->user()->avatar)}}" alt="user" class="img-fluid">
                                                @else
                                                    <img src="{{asset('assets/themes/theme3/images/amelie.png')}}" alt="user" class="img-fluid">
                                                @endif
                                            </div>
