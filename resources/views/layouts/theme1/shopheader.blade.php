                ...
                <div class="logo-col">
                    <h1>
                        <a href="{{route('store.slug',$store->slug)}}">
                            @if(!empty($store->logo))
                                <img src="{{\App\Models\Utility::get_file('uploads/store_logo/'.$store->logo.'?'. time())}}" alt="Image placeholder">
                            @else
                                <img src="{{asset(Storage::url('uploads/store_logo/logo.png'.'?'. time()))}}" alt="Image placeholder">
                            @endif
                        </a>
                    </h1>
                </div>
