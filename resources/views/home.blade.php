                                ...
                                <div class="card-body stats welcome-card">
                                    <div class="row align-items-center mb-4">
                                        <div class="col-xxl-12">
                                            ...
                                            <h4 class="f-w-400">
                                                <img src="{{ \App\Models\Utility::get_file('uploads/profile/' . (!empty(Auth::user()->avatar) ? Auth::user()->avatar : 'avatar.png')) }}" alt="user-image" class="wid-35 me-2 img-thumbnail rounded-circle">{{ __(Auth::user()->name) }}
                                            </h4>
                                                                        ...
                                                                        <div class="media align-items-center gap-3">
                                                                            <div>
                                                                                @if (!empty($product->thumbnail))
                                                                                    <img alt="Image placeholder" src="{{ \App\Models\Utility::get_file('uploads/thumbnail/' . $product->thumbnail)}}" width="80px">
                                                                                @else
