        ...
        <div class="container-fluid">
            ...
            <div class="navbar-user d-lg-none">
                <a class="navbar-brand mr-lg-3 pt-0" href="{{route('store.slug',$store->slug)}}">
                    @if(!empty($store->logo))
                        <img alt="Image placeholder" src="{{\App\Models\Utility::get_file('uploads/store_logo/'.$store->logo)}}" id="navbar-logo" style="height: 40px;">
                    @else
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <a href="{{\App\Models\Utility::get_file('uploads/is_cover_image/'.$products->is_cover)}}" data-fancybox data-caption="My caption">
                                @if(!empty($products->is_cover))
                                    <img alt="Image placeholder" src="{{\App\Models\Utility::get_file('uploads/is_cover_image/'.$products->is_cover)}}" class="img-fluid rounded">
                                @else\App\Models\Utility::get_file
