        ...
        <nav class="navbar navbar-expand-md navbar-light default">
          <div class="container-fluid pe-2">
            <a class="navbar-brand mr-lg-4 pt-0" href="{{route('store.slug',$store->slug)}}">
                @if(!empty($store->logo))
                    <img alt="Image placeholder" src="{{\App\Models\Utility::get_file('uploads/store_logo/'.$store->logo.'?'. time())}}" id="navbar-logo" style="height: 40px;">
                @else
                    <img alt="Image placeholder" src="{{asset(Storage::url('uploads/store_logo/logo.png'.'?'. time()))}}" id="navbar-logo" style="height: 40px;">
                @endif
            </a>
