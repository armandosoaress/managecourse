                                            ...
                                            <div class="product-img">
                                                <a href="{{route('store.search',[$store->slug])}}">
                                                    @if(!empty($course->thumbnail))
                                                        <img alt="card" src="{{\App\Models\Utility::get_file('uploads/thumbnail/'.$course->thumbnail)}}" class="img-fluid">
                                                    @else
                                        ...
                                        <div class="category-img">
                                            <a href="#">
                                                @if(!empty($category->category_image))
                                                    <img alt="Image placeholder" src="{{\App\Models\Utility::get_file('uploads/category_image/'.$category->category_image)}}" class="img-fluid">
                                                @else
                                                    ...
                                                    <div class="product-card-inner">
                                                        <div class="product-img">
                                                            <a href="{{route('store.viewcourse',[$store->slug,\Illuminate\Support\Facades\Crypt::encrypt($course->id)])}}" tabindex="0">
                                                                @if(!empty($course->thumbnail))
                                                                    <img alt="Image placeholder" src="{{\App\Models\Utility::get_file('uploads/thumbnail/'.$course->thumbnail)}}">
                                                                @else
