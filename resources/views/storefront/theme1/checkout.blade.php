                ...
                <div class="col-lg-8 col-12">
                    ...
                    @if (isset($store_payments['is_paystack_enabled']) && $store_payments['is_paystack_enabled'] == 'on')
                        <div class="payment-method">
                            ...
                            <p>{{ __('Pay your order using the most known and secure platform for online money transfers. You will be redirected to Paystack to finish complete your purchase.') }}
                            </p>
                    ...
                    @if (isset($store_payments['is_paytm_enabled']) && $store_payments['is_paytm_enabled'] == 'on')
                        <div class="payment-method">
                            ...
                            <p>{{ __('Pay your order using the most known and secure platform for online money transfers. You will be redirected to Paytm to finish complete your purchase.') }}
                            </p>
                    ...
                    @if (isset($store_payments['is_skrill_enabled']) && $store_payments['is_skrill_enabled'] == 'on')
                        <div class="payment-method">
                            ...
                            <p>{{ __('Pay your order using the most known and secure platform for online money transfers. You will be redirected to Skrill to finish complete your purchase') }}.
                            </p>
                    ...
                    @if (isset($store_payments['is_coingate_enabled']) && $store_payments['is_coingate_enabled'] == 'on')
                        <div class="payment-method">
                            ...
                            <p>{{ __('Pay your order using the most known and secure platform for online money transfers. You will be redirected to CoinGate to finish complete your purchase') }}.
                            </p>
                    ...
                    @if (isset($store_payments['is_toyyibpay_enabled']) && $store_payments['is_toyyibpay_enabled'] == 'on')
                        <div class="payment-method">
                            <div class="payment-title d-flex align-items-center justify-content-between">
                                <h4>{{ __('Toyyibpay') }}</h4>
                                <div class="payment-image extra-size d-flex align-items-center">
                                    <img src="{{ asset('assets/img/toyyibpay.png') }}" alt="Toyyibpay">
                                </div>
                            </div>
                    ...
                    @if (isset($store_payments['is_payfast_enabled']) && $store_payments['is_payfast_enabled'] == 'on' && $store_payments['payfast_merchant_id'] && $store_payments['payfast_merchant_key'])
                        <div class="payment-method">
                            ...
                            <div class="payment-title d-flex align-items-center justify-content-between">
                                <h4>{{ __('Payfast') }}</h4>
                                <div class="payment-image extra-size d-flex align-items-center">
                                    <img src="{{ asset('assets/img/payfast.png') }}" alt="Payfast">
                                </div>
                            </div>
                    ...
                    @if (isset($store_payments['is_iyzipay_enabled']) && $store_payments['is_iyzipay_enabled'] == 'on')
                        <div class="payment-method">
                            ...
                            <form method="POST" action="{{ route('iyzipay.payment', $store->slug) }}" class="payment-method-form">
                                @csrf
                                <input type="hidden" name="transaction_id" class="customer_product" value="{{ date('Y-m-d') . strtotime('Y-m-d H:i:s') . 'user_id' }}">
                                <input type="hidden" name="desc" value="{{ time() }}">
                                <div class="form-group text-right">
                    ...
                    @if (isset($store_payments['is_sspay_enabled']) && $store_payments['is_sspay_enabled'] == 'on')
                        <div class="payment-method">
                            ...
                            <form method="POST" action="{{ route('sspay.prepare.payment', $store->slug) }}" class="payment-method-form">
                                @csrf
                                <input type="hidden" name="transaction_id" class="customer_product" value="{{ date('Y-m-d') . strtotime('Y-m-d H:i:s') . 'user_id' }}">
                                <input type="hidden" name="desc" value="{{ time() }}">
                                <div class="form-group text-right">
                    ...
                    @if (isset($store_payments['is_paytr_enabled']) && $store_payments['is_paytr_enabled'] == 'on')
                        <div class="payment-method">
                            ...
                            <form method="POST" action="{{ route('store.pay.paytr.payment', $store->slug) }}" class="payment-method-form">
                                @csrf
                                <input type="hidden" name="product_id" id="product_id">
                                <div class="form-group text-right">
                                    <button type="submit" class="btn btn-secondary">{{ __('Pay Now') }}</button>
                    ...
                    @if (isset($store_payments['is_yookassa_enabled']) && $store_payments['is_yookassa_enabled'] == 'on')
                        <div class="payment-method">
                            ...
                            <form method="POST" action="{{ route('store.pay.yookassa.payment', $store->slug) }}" class="payment-method-form">
                                @csrf
                                <input type="hidden" name="product_id" id="product_id">
                                <div class="form-group text-right">
                                    <button type="submit" class="btn btn-secondary">{{ __('Pay Now') }}</button>
                    ...
                    @if (isset($store_payments['is_midtrans_enabled']) && $store_payments['is_midtrans_enabled'] == 'on')
                        <div class="payment-method">
                            ...
                            <form method="POST" action="{{ route('store.pay.midtrans.payment', $store->slug) }}" class="payment-method-form">
                                @csrf
                                <input type="hidden" name="product_id" id="product_id">
                                <div class="form-group text-right">
                                    <button type="submit" class="btn btn-secondary">{{ __('Pay Now') }}</button>
                    ...
                    @if (isset($store_payments['is_xendit_enabled']) && $store_payments['is_xendit_enabled'] == 'on')
                        <div class="payment-method">
                            ...
                            <form method="POST" action="{{ route('store.pay.xendit.payment', $store->slug) }}" class="payment-method-form">
                                @csrf
                                <input type="hidden" name="product_id" id="product_id">
                                <div class="form-group text-right">
                                    <button type="submit" class="btn btn-secondary">{{ __('Pay Now') }}</button>
