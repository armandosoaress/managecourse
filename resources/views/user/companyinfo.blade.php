                                        ...
                                        <div class="text-end">
                                            <div class="form-check form-switch custom-switch-v1 mt-3">
                                                <input type="checkbox" name="store_disable"
                                                    ...
                                                    data-id="{{ $user_data['store_id'] }}" data-company="{{ $id }}"
                                                    data-name="{{ __('store') }}"
                                            ...
                                            <div class="col-md-6 my-2 ">
                                                <div
                                                    ...
                                                    <div class="mb-3 mb-sm-0">
                                                        <h6>
                                                            <img alt="" src="{{ \App\Models\Utility::get_file("uploads/profile/").'/'}}{{ !empty($user->avatar)?$user->avatar:'avatar.png' }}" class=" wid-30 rounded-circle mx-2" alt="image"
                                                            height="30">
                                                            <label for="user"
                                                    ...
                                                    <div class="text-end ">
                                                        <div class="form-check form-switch custom-switch-v1 mb-2">
                                                            <input type="checkbox" name="user_disable"
                                                                ...
                                                                data-name="{{ __('user') }}"
                                                                {{ $user->is_disable == 1 ? 'checked' : '' }} {{ $store->is_active == 1 ? '' : 'disabled' }}>
