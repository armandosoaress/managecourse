...
@section('action-btn')
    @if($plansetting['enable_chatgpt'] && $plansetting['enable_chatgpt']=='on')
        <a href="#" class="btn btn-primary btn-sm" data-size="lg" data-ajax-popup-over="true" data-url="{{ route('generate',['chapter']) }}" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ __('Generate') }}" data-title="{{ __('Generate Content With AI') }}">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-12 col-lg-12">
                                ...
                                {{Form::textarea('chapter_description',null,array('class'=>'summernote form-control font-style','id'=>'exampleFormControlTextarea1','required'=>'required'))}}
                            </div>
                                        ...
                                        <div class="attachment-upload">
                                            <div class="attachment-button">
                                                <div class="pull-left">
                                                    ...
                                                    <a href="{{ \App\Models\Utility::get_file('uploads/chapters/' . $chapters->video_file) }}" target="_blank">
                                                        <video height="80px" controls="" class="mt-2">
                                                            <source id="video_file" src="{{ \App\Models\Utility::get_file('uploads/chapters/' . $chapters->video_file) }}" type="video/mp4">
                                                        </video>
                                                    </a>
                                                </div>
                                            </div>
                                                        ...
                                                        <div class="row align-items-center">
                                                            <div class="col ml-n2">
                                                                <p class="card-text small text-muted">
                                                                    <img class="rounded" src=" {{\App\Models\Utility::get_file('uploads/chapters/'.$files->chapter_files)}}" width="70px" alt="Image placeholder" data-dz-thumbnail>
                                                                </p>
                                                            </div>
                                                            <div class="col-auto actions">
                                                                <a class="action-item" href=" {{\App\Models\Utility::get_file('uploads/chapters/'.$files->chapter_files)}}" download="" data-toggle="tooltip" data-original-title="{{__('Download')}}">
