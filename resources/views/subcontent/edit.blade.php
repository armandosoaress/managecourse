...
<div class="row">
    ...
    <div class="form-group col-md-12 col-lg-12">
        ...
        {{Form::textarea('description',null,array('class'=>'form-control summernote','id'=>'exampleFormControlTextarea1','required'=>'required'))}}
    </div>
                                ...
                                <div class="row align-items-center">
                                    <div class="col ml-n2">
                                        <p class="card-text small text-muted">
                                            <img class="rounded" src=" {{\App\Models\Utility::get_file('uploads/contents/'.$file->content)}}" width="70px" alt="Image placeholder" data-dz-thumbnail>
                                        </p>
                                    </div>
                                    <div class="col-auto actions">
                                        <a class="action-item" href=" {{\App\Models\Utility::get_file('uploads/contents/'.$file->content)}}" download="" data-toggle="tooltip" data-original-title="{{__('Download')}}">
