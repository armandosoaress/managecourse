...
class PlanController extends Controller
{
    ...
    public function index()
    {
        if(\Auth::user()->can('manage plan')){
            ...
            if($objUser->type == 'super admin')
            {
                ...
                )->join('users', 'plan_orders.user_id', '=', 'users.id')->orderBy('plan_orders.created_at', 'DESC')->with('total_coupon_used.coupon_detail')->get();
            }
            else
            {
                $orders = PlanOrder::select(
                ...
                )->join('users', 'plan_orders.user_id', '=', 'users.id')->orderBy('plan_orders.created_at', 'DESC')->where('users.id', '=', $objUser->id)->with('total_coupon_used.coupon_detail')->get();
            }
    ...
    public function planorderdestroy($order_id)
    {
