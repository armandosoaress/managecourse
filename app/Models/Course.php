...
{
    private static $courseratting = null;
    ...
    public function course_rating()
    {
        ...
        {
            $avg_rating = number_format(self::$courseratting / self::$userratting, 1);
        }
        else
        {
            $avg_rating = number_format(self::$courseratting / 1, 1);
