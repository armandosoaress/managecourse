...
class Store extends Model
{
    ...
    private static $fetchuserstore = null;
    protected $fillable = [
        'name',
        'email',
        'domains',
    ...
    public static function storeSlug($slug)
    {
    ...
    public static function userStore($store_id)
    {
        if(is_null(self::$fetchuserstore))
        {
            $userstore = UserStore::where('store_id', $store_id)->first();
            self::$fetchuserstore = $userstore;
        }
        return self::$fetchuserstore;
    }
