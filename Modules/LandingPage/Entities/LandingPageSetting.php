...
class LandingPageSetting extends Model
{
    ...
    private static $fetchlandingpagesetting = null;
    ...
    {
        if(self::$fetchlandingpagesetting === null)
        {
            $data = LandingPageSetting::get();

            self::$fetchlandingpagesetting = $data;
        }
        $settings = [
            "topbar_status" => "on",
        ...
        foreach(self::$fetchlandingpagesetting as $row)
        {
