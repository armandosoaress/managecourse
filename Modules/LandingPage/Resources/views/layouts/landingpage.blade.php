            ...
            <nav class="navbar navbar-expand-md  default top-nav-collapse">
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                    <ul class="navbar-nav">
                        ...
                        @if ($value->header == 'on')
                        <li class="nav-item">
                            <a class="nav-link" @if(!empty($value->page_url)) href="{{ $value->page_url }}" target="_blank" @else href="{{ route('custom.page',$value->page_slug) }}" @endif>{{ $value->menubar_page_name }}</a>
                        </li>
                        @endif
                        @endforeach
                        @endif
                ...
                <div class="ms-auto d-flex justify-content-end gap-2">
                    <a href="{{ route('login',$lang) }}" class="btn btn-outline-dark rounded"><span
                    ...
                    @if(App\Models\Utility::getValByName('signup') == 'on')
                        <a href="{{ route('register') }}" class="btn btn-outline-dark rounded"><span
                            class="hide-mob me-2">{{__('Register')}}</span> <i data-feather="user-check"></i>
                        </a>
                    @endif
                    ...
                    <div class="col-xxl-3 col-lg-4 col-md-6">
                        <div
                            ...
                            <div class="card-body">
                                ...
                                <span class="mb-4 f-w-600 p-price">{{!empty($payment_setting['currency_symbol'])? $payment_setting['currency_symbol']:'$'}}{{$value->price }}<small
                                ...
                                <ul class="list-unstyled my-3">
                                    ...
                                    <li>
                                        <div class="form-check text-start">
                                            <label class="form-check-label"
                                                for="customCheckc1">{{ $value->enable_custdomain ==1 ? 'Enable' : 'Disable' }}
                                    ...
                                    <li>
                                        <div class="form-check text-start">
                                            <label class="form-check-label"
                                                for="customCheckc1">{{ $value->enable_custsubdomain ==1 ? 'Enable' : 'Disable' }} {{__('Sub Domain')}}</label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="form-check text-start">
                                            <label class="form-check-label"
                                                for="customCheckc1">{{ $value->additional_page ==1 ? 'Enable' : 'Disable' }}
                                    ...
                                    <li>
                                        <div class="form-check text-start">
                                            <label class="form-check-label"
                                                for="customCheckc1">{{ $value->blog ==1 ? 'Enable' : 'Disable' }} {{__('Blog')}}</label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="form-check text-start">
                                            <label class="form-check-label"
                                                for="customCheckc1">{{ $value->enable_chatgpt ==1 ? 'Enable' : 'Disable' }} {{__('Chatgpt')}}</label>
                                        </div>
                                    </li>
    ...
    <footer class="site-footer bg-gray-100">
            ...
            <div class="footer-row">
                ...
                <div class="ftr-col">
                    <ul class="list-unstyled">
                        ...
                        <li><a @if(!empty($value->page_url)) href="{{ $value->page_url }}" target="_blank" @else href="{{ route('custom.page',$value->page_slug) }}" @endif>{!! $value->menubar_page_name !!}</a></li>
                        @endif
        ...
        <div class="border-top border-dark text-center p-2">
            ...
            <p class="mb-0"> &copy; {{ date('Y') }}
                {{ Utility::getValByName('footer_text') ? Utility::getValByName('footer_text') : config('app.name', 'LmsGo SaaS') }}
            </p>
        </div>
    </footer>
    <!-- [ Footer ] end -->
