                                                ...
                                                @foreach ($discover_of_features as $key => $value)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span>
                                                                <div class="d-flex">
                                                                        <a href="#" class="action-btn btn btn-sm btn-icon bg-info me-2" data-url="{{ route('discover_edit',$key) }}" data-ajax-popup="true" data-title="{{__('Edit Discover')}}" data-size="lg" data-bs-toggle="tooltip"  title="{{__('Edit')}}" data-original-title="{{__('Edit')}}">
