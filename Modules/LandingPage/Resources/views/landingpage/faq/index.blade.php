                                                ...
                                                @foreach ($faqs as $key => $value)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span>
                                                                <div class="d-flex">
                                                                    <a href="#" class="action-btn btn btn-sm btn-icon bg-info me-2" data-url="{{ route('faq_edit',$key) }}" data-ajax-popup="true" data-title="{{__('Edit FAQ')}}" data-size="lg" data-bs-toggle="tooltip"  title="{{__('Edit')}}" data-original-title="{{__('Edit')}}">
