                                                    ...
                                                    <div class="card mb-3 border shadow-none product_Image">
                                                        <div class="px-2 py-2">
                                                            <div class="row align-items-center">
                                                                ...
                                                                <div class="col-auto">
                                                                    <a class="action-btn btn btn-sm btn-icon bg-warning" href="{{ $logo.'/'.$home_logo }}" download="" data-toggle="tooltip" data-original-title="Download">
                                                                        <i class="ti ti-download"></i>
                                                                    </a>
                                                                </div>
                                                                <div class="col-auto">
                                                                    <a class="action-btn btn btn-sm btn-icon bg-danger delete-button" data-image="{{ $home_logo }}">
