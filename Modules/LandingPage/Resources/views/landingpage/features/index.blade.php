...
@push('script-page')
    <script src="{{asset('libs/summernote/summernote-bs4.js')}}" referrerpolicy="origin"></script>
@endpush
                            ...
                            <div class="card-header">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-3 justify-content-end d-flex">
                                        <a data-size="lg" data-url="{{ route('feature_create') }}" data-ajax-popup="true"   data-bs-toggle="tooltip" data-title="{{__('Feature List')}}"  class="btn btn-sm btn-primary">
                                                ...
                                                @foreach ($feature_of_features as $key => $value)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span>
                                                                <div class="d-flex">
                                                                        <a href="#" class="action-btn btn btn-sm btn-icon bg-info me-2" data-url="{{ route('feature_edit',$key) }}" data-ajax-popup="true" data-title="{{__('Edit Feature')}}" data-size="lg" data-bs-toggle="tooltip"  title="{{__('Edit')}}" data-original-title="{{__('Edit')}}">
                                                ...
                                                @foreach ($other_features as $key => $value)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span>
                                                                <div class="d-flex">
                                                                    <a href="#" class="action-btn btn btn-sm btn-icon bg-info me-2" data-url="{{ route('features_edit',$key) }}" data-ajax-popup="true" data-title="{{__('Edit Feature Block')}}" data-size="lg" data-bs-toggle="tooltip"  title="{{__('Edit')}}" data-original-title="{{__('Edit')}}">
                                                                        <i class="ti ti-edit text-white"></i>
                                                                    </a>
                                                                    <a class="bs-pass-para action-btn btn btn-sm btn-icon bg-danger" href="#"
                                                                        data-confirm="{{ __('Are You Sure?') }}"
