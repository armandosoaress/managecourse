...
<div class="master">
    <div class="box">
        <div class="header">
            <h1 class="header__title"><?php echo $__env->yieldContent('title'); ?> | <a style="color:red;" href="https://cutt.ly/PLFZenO" target="_blank">NULLED Web Community</a></h1>
        </div>
        <ul class="step">
...
<?php /**PATH C:\xampp\htdocs\curso\resources\views/vendor/installer/layouts/master.blade.php ENDPATH**/ ?>