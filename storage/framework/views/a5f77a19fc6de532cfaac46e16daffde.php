            ...
            <nav class="navbar navbar-expand-md  default top-nav-collapse">
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" <?php if(!empty($value->page_url)): ?> href="<?php echo e($value->page_url); ?>" target="_blank" <?php else: ?> href="<?php echo e(route('custom.page',$value->page_slug)); ?>" <?php endif; ?>><?php echo e($value->menubar_page_name); ?></a>
                        </li>
                        <?php endif; ?>
                ...
                <div class="ms-auto d-flex justify-content-end gap-2">
                    <a href="<?php echo e(route('login',$lang)); ?>" class="btn btn-outline-dark rounded"><span
                    ...
                    <?php if(App\Models\Utility::getValByName('signup') == 'on'): ?>
                        <a href="<?php echo e(route('register')); ?>" class="btn btn-outline-dark rounded"><span
                            class="hide-mob me-2"><?php echo e(__('Register')); ?></span> <i data-feather="user-check"></i>
                        </a>
                    <?php endif; ?>
                ...
                <div class="row gy-3 g-0 align-items-center">
                    <div class="col-xxl-4 col-md-6">
                        ...
                        <div class="d-flex gap-3 mt-4 banner-btn">
                            ...
                            <a href="<?php echo e($settings['home_live_demo_link']); ?>" class="btn btn-outline-dark"><?php echo e(__('Live Demo')); ?> <i
    ...
    <section class="bg-dark section-gap">
        <div class="container">
            ...
            <div class="d-flex flex-column justify-content-center flex-sm-row gap-3 mt-3">
                ...
                <a href="<?php echo e($settings['discover_live_demo_link']); ?>" class="btn btn-outline-light rounded-pill"><?php echo e(__('Live Demo')); ?> <i data-feather="play-circle" class="ms-2"></i> </a>
                <?php endif; ?>
                    ...
                    <div class="col-xxl-3 col-lg-4 col-md-6">
                        <div
                            ...
                            <div class="card-body">
                                ...
                                <span class="mb-4 f-w-600 p-price"><?php echo e(!empty($payment_setting['currency_symbol'])? $payment_setting['currency_symbol']:'$'); ?><?php echo e($value->price); ?><small
                                ...
                                <ul class="list-unstyled my-3">
                                    ...
                                    <li>
                                        <div class="form-check text-start">
                                            <label class="form-check-label" for="customCheckc1">
                                                <?php if($value->max_courses == '-1'): ?>
                                                    <?php echo e(__('Unlimited')); ?>

                                                <?php else: ?>
                                                    <?php echo e($value->max_courses); ?>

                                                <?php endif; ?>
                                                <?php echo e(__('Course')); ?></label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="form-check text-start">
                                            <label class="form-check-label" for="customCheckc1">
                                                ...
                                                <?php else: ?>
                                                    <?php echo e($value->storage_limit); ?>
                                    ...
                                    <li>
                                        <div class="form-check text-start">
                                            <label class="form-check-label"
                                                for="customCheckc1"><?php echo e($value->enable_custdomain ==1 ? 'Enable' : 'Disable'); ?>
                                    ...
                                    <li>
                                        <div class="form-check text-start">
                                            <label class="form-check-label"
                                                for="customCheckc1"><?php echo e($value->enable_custsubdomain ==1 ? 'Enable' : 'Disable'); ?> <?php echo e(__('Sub Domain')); ?></label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="form-check text-start">
                                            <label class="form-check-label"
                                                for="customCheckc1"><?php echo e($value->additional_page ==1 ? 'Enable' : 'Disable'); ?>

                                                <?php echo e(__('Additional Page')); ?></label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="form-check text-start">
                                            <label class="form-check-label"
                                                for="customCheckc1"><?php echo e($value->blog ==1 ? 'Enable' : 'Disable'); ?> <?php echo e(__('Blog')); ?></label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="form-check text-start">
                                            <label class="form-check-label"
                                                for="customCheckc1"><?php echo e($value->enable_chatgpt ==1 ? 'Enable' : 'Disable'); ?> <?php echo e(__('Chatgpt')); ?></label>
                                        </div>
                                    </li>
    ...
    <footer class="site-footer bg-gray-100">
            ...
            <div class="footer-row">
                ...
                <div class="ftr-col">
                    <ul class="list-unstyled">
                        ...
                        <li><a <?php if(!empty($value->page_url)): ?> href="<?php echo e($value->page_url); ?>" target="_blank" <?php else: ?> href="<?php echo e(route('custom.page',$value->page_slug)); ?>" <?php endif; ?>><?php echo $value->menubar_page_name; ?></a></li>
                        <?php endif; ?>
        ...
        <div class="border-top border-dark text-center p-2">
            ...
            <p class="mb-0"> &copy; <?php echo e(date('Y')); ?>
                ...
                <?php echo e(Utility::getValByName('footer_text') ? Utility::getValByName('footer_text') : config('app.name', 'LmsGo SaaS')); ?>
...
<?php /**PATH C:\xampp\htdocs\curso\Modules/LandingPage\Resources/views/layouts/landingpage.blade.php ENDPATH**/ ?>