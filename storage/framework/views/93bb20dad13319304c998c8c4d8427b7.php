<!DOCTYPE html>
<html lang="en" data-theme="<?php echo e(isset($gradiant) ? $gradiant : 'color-one'); ?>">
<head>
    <meta charset="UTF-8">
                        ...
                        <div class="certificate_1_main">
                            <div class="certificate_border">
                                <div class="certificate_heading">
                                    <h1><?php echo e(isset($settings->header_name)?$settings->header_name:'{store_name}'); ?> </h1>
                                    <!-- <span>Of achievement</span>   Harvard University -->
                                </div>
                                <div class="certificate_holder">
                                    <h2><?php echo e(isset($student->name)?$student->name:'{student_name}'); ?></h2>
                                </div>
                                <div class="certificate_sub_heading">
                                    <h3><?php echo e(__('has earned')); ?></h3>
                                    <span>
                                        <?php if(empty($student->course_time)): ?>
                                            <span> <?php echo e('<Course Time>'); ?> </span>
                                        <?php else: ?>
                                            <?php echo e($student->course_time); ?> <?php echo e(__('Hours')); ?>
                                ...
                                <div class="certificate_description">
                                    <p><?php echo e(__('A certificate of appreciation for students in word is a certificate that is written and sent via mail or any other online platform. The certificate is not printed, and all details are written virtually when coming up with the certificate. This process is fast and less costly.')); ?></p>
                                    <?php if(empty($student->course_name)): ?>
                                        <span> <?php echo e('<Course Name>'); ?> </span>
                                    <?php else: ?>
                                        <?php echo e($student->course_name); ?>
                                ...
                                <div class="certificate_footer">
                                    <div class="certificate_logo">
                                        <img src="<?php echo e(asset('certificate/img/logo.png')); ?>" alt="logo">
                                    </div>
                                    <div class="signature_section">
                                        <div class="signature_image">
                                        </div>
                                        <div class="signature_text">
                                            <h4><?php echo e(__('signature')); ?></h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<?php /**PATH C:\xampp\htdocs\curso\resources\views/settings/templates/template1.blade.php ENDPATH**/ ?>