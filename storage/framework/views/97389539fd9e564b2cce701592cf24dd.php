    ...
    <div class="min-vh-100 h-100vh py-5 d-flex align-items-center bg-gradient-primary">
        <div class="bg-absolute-cover vh-100 overflow-hidden d-none d-md-block">
            <figure class="w-100">
                ...
                <img alt="Image placeholder" src="<?php echo e(env('APP_URL').'/assets/img/bg-4.svg'); ?>" class="svg-inject">
            </figure>
        </div>
            ...
            <div class="row justify-content-center align-items-center">
                ...
                <div class="col-lg-6 d-none d-lg-block">
                    <figure class="w-100">
                        ...
                        <img alt="Image placeholder" src="<?php echo e(env('APP_URL').'/assets/img/design-thinking.svg'); ?>" class="svg-inject opacity-8 img-fluid" style="height: 500px;">
                    </figure>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('errors::minimal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\curso\resources\views/errors/404.blade.php ENDPATH**/ ?>